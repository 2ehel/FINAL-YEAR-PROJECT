    ...
    <body>
        ...
        <div style="border: 1px solid gray;
            ...
            <div style="width: 500px;margin: auto;">
                <form class="needs-validation" novalidate action="admin-product-update-process.jsp" method="post">
                    <div class="mb-3">
                        <label for="productID">ID *</label>
                        <input type="text" name="productID" class="form-control" id="productID" value="<%=product.getProductID()%>" readonly="readonly">
                    </div>
                    <div class="mb-3">
                        <label for="productName">Name *</label>
                        <input type="text" name="productName" class="form-control" id="productName" value="<%=product.getProductName()%>">
                    </div>
                    <div class="mb-3">
                        <label for="productName">Category *</label>
                        <select type="text" name="productCategory" class="form-control" id="productCategory" value="<%=product.getProductCategory()%>">
                        <option value="Laptop">Laptop</option>
                        <option value="PC">PC</option>
                        <option value="Peripherals">Peripherals</option></select>
                    </div>
                    <div class="mb-3">
                        <label for="productPrice">Price *</label>
                        <input type="int" name="productPrice" class="form-control" id="productPrice" value="<%=product.getProductPrice()%>" >
                    </div>
                    <div class="mb-3">
                        <label for="productCondition">Condition *</label>
                        <select type="text" name="productCondition" class="form-control" id="productCondition" value="<%=product.getProductCondition()%>" >
                        <option value="New">New</option>
                        <option value="Used">Used</option></select>
                    </div>
                    <div class="mb-3">
                        <label for="totalStock">In Stock *</label>
                        <input type="text" name="totalStock" class="form-control" id="totalStock" value="<%=product.getTotalStock()%>" >
                    </div>
                    <div class="mb-3">
                        <label for="productDesc">Description *</label>
                        <input type="text" name="productDesc" class="form-control" id="productDesc" value="<%=product.getProductDesc()%>" >
                    </div>
        ...
        <div class="footer-copyright">
            <p class="footer-company">All Rights Reserved. &copy; <a href="#">Endgame Tech CS</a></p>
        </div>
        <!-- End copyright  -->
