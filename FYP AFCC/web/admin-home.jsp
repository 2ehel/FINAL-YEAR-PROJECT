    ...
    <body>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="our-link">
                            <ul>
                                <li><a href="admin-account-details.jsp">Admin : <%=admin.getAdminName()%></a></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="admin-home.jsp"><img src="images/logo.png" class="logo" alt=""></a>
                    </div>
        ...
        <div style="border: 1px solid gray;
            ...
            <h1 style="text-align: center;
                ...
                color: black;">WELCOME ADMIN, <%=admin.getAdminName()%> <br>ENDGAME TECH CS<br>ADMINISTRATION SYSTEM</h1>
            <center>
                <a href="viewProduct.jsp"><button class="button button3" style="margin-right: auto">Manage Product</button></a>
                <a href="admin-order.jsp"><button class="button button3" style="margin-right: auto">Manage Order</button>
                <a href="admin-contact.jsp"><button class="button button3" style="margin-right: auto">Customer Service</button>
            </center>
        </div>
        <!--End of Main Section-->
