            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="our-link">
                            <ul>
                                <li><a href="admin-account-profile.jsp">ADMIN : <%=admin.getAdminName()%></a></li>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-12">
                        <div class="contact-info-left">
                            <h2>Account Info</h2>
                            <form action="admin-update-process.jsp" method="post"><table>
                                    <td><div class="form-group">
                                            <div class="mb-3">
                                                <label for="userId">Admin ID</label> 
                                                <input type="text" name ="adminID" class="form-control" id="adminID" value="<%=admin.getAdminID()%>" readonly="readonly">
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" placeholder="Email Address" name="adminEmail" value="<%=admin.getAdminEmail()%>" />
                                </div>
                                <table>
                                    <td>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input type="password" class="form-control" placeholder="Password"  name="adminPassword" id="password" value="<%=admin.getAdminPassword()%>" />
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <label>Confirm password</label>
                                            <input type="password" class="form-control" placeholder="Password" name="repassword" id="repassword" />
                                        </div>
                                    </td>
                                </table><table>
                    ...
                    <div class="col-lg-4 col-sm-12">
                        <div class="contact-info-left" style="width: auto">
                            ...
                            <form action="registerAdmin.jsp" method="post">
                                <div class="row">
                                    <button type="submit"  class="form-control">Register Admin</button>
                                </div>
