    ...
    <body>
        ...
        <div style="border: 1px solid gray;
            ...
            <h1 style="text-align: center;
                ...
                color: black;">ENDGAME TECH CS<br>LOGIN</h1>
            <div style="width: 500px;margin: auto;">
                <form class="needs-validation" novalidate action="admin-login-process.jsp" method="post">
                    <div class="mb-3">
                    ...
                    <div class="col-12 d-flex shopping-box">
                        <label ></label>
                        <input type="submit" class="ml-auto btn hvr-hover" value="Login">
                    </div>
                    <hr class="mb-1"> 
                </form><br><br>
                <br><br>
