...
<html lang="en">
    ...
    <%
        ...
        List<Contact> contact = contactdao.retrieveAllContact();
    %>
    <body>
        ...
        <div style="border: 1px solid gray;
            ...
            <h1 style="text-align: center;
                ...
                color: black;">ENDGAME TECH CS<br>ADMINISTRATION SYSTEM<br><br>MESSAGE</h1>
            <center>
                <table style="width:80%; font-size: 23px">
                    ...
                    <tr>
                        <td><%=contact.get(i).getContactID()%></td>
                        <td><%=contact.get(i).getUserID()%></td>
                        <td><%=contact.get(i).getSubject()%></td>
                        <td><a href="admin-order-view.jsp?id=<%=contact.get(i).getMessage()%>" class="btn btn-outline-warning btn-sm">VIEW</a>
                    </tr>
                    <% }%>
