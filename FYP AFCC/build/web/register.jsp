                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-6 mb-3">
                        <div class="checkout-address">
                            ...
                            <form class="needs-validation" novalidate action="register-process.jsp" method="post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="user_phone" class="form-control" id="user_phone" placeholder="" required>
                                    <div class="invalid-feedback"> Please enter your password. </div>
                                </div>
