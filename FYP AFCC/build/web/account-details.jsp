        ...
        <div class="contact-box-main">
            <div class="container">
                <div class="row">
                        ...
                        <div class="contact-info-left">
                            ...
                            <form action="update.jsp" method="post"><table>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="fname" value="<%=user.getFname()%>" disabled />
                                    </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <label>Last Name</label>
                                            <input type="text" class="form-control" name="lname" value="<%=user.getLname()%>" disabled />
                                        </div>
                                    </td>
                                </table>
                                <div class="form-group">
                                    <label>Email address</label>
                                    <input type="email" class="form-control" placeholder="Email Address" name="email" value="<%=user.getUser_email()%>" disabled/>
                                </div>
                                <table>
                                    <td>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input type="password" class="form-control" placeholder="Password"  name="password" id="password" value="<%=user.getUser_password()%>" disabled/>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <label>Confirm password</label>
                                            <input type="password" class="form-control" placeholder="Password" name="repassword" id="repassword" disabled/>
                                        </div>
                                    </td>
                                </table><table>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="contact Number" name="phoneNumber" value="<%=user.getUser_phone()%>" disabled/>
                                    </div>
                    ...
                    <div class="col-lg-4 col-sm-12">
                        <div class="contact-info-left" style="width: auto">
                            <h2>Order Info</h2>
                            <form action="order.jsp" method="post">
                            <div class="row">
                                <button type="submit"  class="form-control">View Order</button>
                            </div>
