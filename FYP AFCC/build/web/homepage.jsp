            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="our-link">
                            <ul>
                                <li><a href="account-profile.jsp"></a></li>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="m-b-40">Customize your <b>"Bangsawan"</b> setup<br> or get a complete PC setup here.</p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" style="max-width: 100%; height: 200px" src="images/product.jpg" alt="" />
                            <a class="btn hvr-hover" href="product-detail.jsp">Product</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" style="max-width: 100%; height: 200px" src="images/location.jpg" alt="" />
                            <a class="btn hvr-hover" href="location.jsp">Location</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" style="max-width: 100%; height: 200px" src="images/service.jpg" alt="" />
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            ...
                            <a class="btn hvr-hover" href="cart-add.jsp?id=<%=product.get(1).getProductID()%>">All White i5 11400f & RTX 3060</a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="shop-cat-box">
                            <img class="img-fluid" style="max-width: 100%; height: 300px" src="images/laptop/vivobook1.png" alt="" />
                            <a class="btn hvr-hover" href="cart-add.jsp?id=<%=product.get(2).getProductID()%>">Vivo Book (2022)</a>
                        </div>
                    </div>
                </div>
            </div>
