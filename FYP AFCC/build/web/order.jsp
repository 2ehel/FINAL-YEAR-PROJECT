        ...
        <table id="myTable" class="table table-responsive" style="margin-right:auto;">
            <thead>
                <tr class="names">
                    ...
                    <th style="widhth:10%">Last Name</th>
                    <th style="width:10%">Address</th>
                    <th style="width:10%"></th>
                    <th style="width:10%">Grand Total (RM) </th>
            ...
            <%
                try {
                    ...
                    while (rs.next()) {
                        ...
                        String address2 = rs.getString("orderAddress2");
                        String grandTotal = rs.getString("grandTotal");
                        String pMethod = rs.getString("orderPaymentMethod");
