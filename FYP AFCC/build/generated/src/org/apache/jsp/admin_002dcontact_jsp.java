...
public final class admin_002dcontact_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 for (int i = 0; i < contact.size(); i++) {
      ...
      out.write("                    <tr>\n");
      out.write("                        <td>");
      out.print(contact.get(i).getContactID());
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(contact.get(i).getUserID());
      out.write("</td>\n");
      out.write("                        <td>");
      out.print(contact.get(i).getSubject());
      out.write("</td>\n");
      out.write("                        <td><a href=\"admin-order-view.jsp?id=");
      out.print(contact.get(i).getMessage());
